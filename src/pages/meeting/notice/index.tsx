    ...
    <div>
      <ul className="flex h-full flex-col bg-white">
        {data.length > 0 ? (
          ...
          <div className="flex h-full flex-col items-center justify-center space-y-4 bg-white text-center">
            ...
            <p className="text-xl font-normal text-[#C3C7D0]">등록된 공지가 없습니다.</p>
          </div>
        )}
      </ul>
      <button
      ...
      >
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
          <path d="M8 1V15M1 8H15" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
        </svg>
      </button>
    </div>
  );
