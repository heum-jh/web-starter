...
import MyPagePost from "src/components/my/post";
    ...
    <div className="mt-5">
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="mt-[2rem] flex w-full gap-2 px-5 text-[1rem]/[1.5rem] font-medium text-[#A2A9B5]">
          <div
            onClick={() => router.push("/my/profile-change")}
            className="flex h-10 flex-1 cursor-pointer items-center justify-center rounded-[0.25rem] bg-[#F4F4F5]"
          >
            프로필 수정
          </div>
          <div
